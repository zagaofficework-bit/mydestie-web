<?php
	...
	$app_lang['recipe_rating']="You have succesfully rated !";
	...
	$app_lang['user_not_rate']= "User Not Rated";

	$app_lang['user_rate']= "User Rated";

	//Delete Account
	$app_lang['account_deleted']="Account deleted successfully...";
