					...
					<div class="dropdown" style="float:right">
						<button class="btn btn-primary dropdown-toggle btn_cust" type="button" data-toggle="dropdown">Action
							...
							<ul class="dropdown-menu" style="right:0;left:auto;">
								<li><a href="" class="actions" data-action="enable" data-table="tbl_places" data-column="p_id">Enable</a></li>
								<li><a href="" class="actions" data-action="disable" data-table="tbl_places" data-column="p_id">Disable</a></li>
								<li><a href="" class="actions" data-action="delete" data-table="tbl_places" data-column="p_id">Delete !</a></li>
							</ul>
						</div>
					</div>
				</div>
									...
									<div class="block_wallpaper">
										<div class="wall_category_block">
											...
											<?php if($row['place_featured']!="0"){?>
												<a class="toggle_btn_a" href="javascript:void(0)" data-id="<?php echo $row['p_id'];?>" data-action="disable" data-column="place_featured" data-toggle="tooltip" data-tooltip="Featured"><div style="color:green;"><i class="fa fa-check-circle"></i></div></a> 
											<?php }else{?>

												<a class="toggle_btn_a" href="javascript:void(0)" data-id="<?php echo $row['p_id'];?>" data-action="enable" data-column="place_featured" data-toggle="tooltip" data-tooltip="Set Featured"><i class="fa fa-circle"></i></a> 
											<?php }?>
										...
										<div class="wall_image_title">
											...
											<ul>
												...
												<li><a href="" class="btn_delete" data-id="<?php echo $row['p_id'];?>" data-toggle="tooltip" data-tooltip="Delete" data-table="tbl_places"><i class="fa fa-trash"></i></a></li>

												
												<li>
													<div class="row toggle_btn">
														<input type="checkbox" id="enable_disable_check_<?=$i?>" data-id="<?=$row['p_id']?>" data-table="tbl_places" data-column="place_status" class="cbx hidden enable_disable" <?php if($row['place_status']==1){ echo 'checked';} ?>>
