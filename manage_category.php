              ...
              <div class="block_wallpaper add_wall_category">           
                <div class="wall_image_title">
                  ...
                  <ul>                
                    ...
                    <li>
                      <a href="javascript:void(0)" class="btn_delete" data-id="<?php echo $row['cid'];?>"  data-toggle="tooltip" data-tooltip="Delete" data-table="tbl_category"><i class="fa fa-trash"></i></a>
                    </li>
